package com.ventapasajes.document;
...
class RuntimeProfileConfigurationTest {
    ...
    void applicationPropertiesDeclareGcpAndOnPremiseProfiles() throws IOException {
        ...
        assertContains(properties, "%gcp.quarkus.datasource.username=${APP_DB_USERNAME:document-service-run@project-fbb34cd7-0b82-43e1-867.iam}");
        ...
        assertContains(properties, "%onprem.quarkus.datasource.jdbc.url=${APP_DB_JDBC_URL:jdbc:postgresql://localhost:5432/documents_db}");
    }
