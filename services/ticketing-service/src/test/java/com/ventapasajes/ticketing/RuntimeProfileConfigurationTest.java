package com.ventapasajes.ticketing;
...
class RuntimeProfileConfigurationTest {
    ...
    void applicationPropertiesDeclareGcpAndOnPremiseProfiles() throws IOException {
        ...
        assertContains(properties, "%gcp.quarkus.datasource.username=${APP_DB_USERNAME:ticketing-service-run@project-fbb34cd7-0b82-43e1-867.iam}");
