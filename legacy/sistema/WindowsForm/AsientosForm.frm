...
If TxtUbicacion.Text = "" Then MsgBox "El campo Ubicación esta vacio", vbInformation, "Aviso": TxtUbicacion.SetFocus: Exit Sub
    ...
    ''estamos en la seccion 2
        DrFacturacion.Sections("Sección2").Controls("Etiqueta4").Caption = FacID
...
With RsClientes
        If .BOF Or .EOF Then Exit Sub
                    ...
                    TxtNombre.Text = DataClientes1.Columns(1).Text
                    TxtApellido.Text = DataClientes1.Columns(2).Text
                    TxtDNI.Text = DataClientes1.Columns(3).Text
                    TxtPrecio.Text = DataClientes1.Columns(4).Text
                    DataBuses.Text = DataClientes1.Columns(5).Text
                    TxtTipo.Text = DataClientes1.Columns(6).Text
                    TxtOrigen.Text = DataClientes1.Columns(7).Text
                    TxtDestino.Text = DataClientes1.Columns(8).Text
                    TxtHora.Text = DataClientes1.Columns(9).Text
                    TxtFecha.Text = DataClientes1.Columns(10).Text
                    TxtTime.Text = DataClientes1.Columns(11).Text
                    TxtDate.Text = DataClientes1.Columns(12).Text
                    TxtAsiento.Text = DataClientes1.Columns(13).Text
                    TxtUbicacion.Text = DataClientes1.Columns(14).Text
End With
End Sub
